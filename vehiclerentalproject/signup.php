<?php 
	...
	if(isset($_POST['submit'])){
		...
		$file=$_FILES['file']['name'];
			...
			if($fname==''or$lname==''or$email==''or $mobile==''or $address==''or $password==''or$conformpassword==''){
				...
				if($password==$conformpassword){
					$sql="insert into `signin` (firstname,lastname,email,mobile,address,password,conformpassword,profile_image) values('$fname','$lname','$email','$mobile','$address','$password','$conformpassword','$file')";
